// APP DIRECTIVES - original filename: ng.directive.js; assumingly, also contains
// controller and factories?!
// Also namespaced everything with 'sa' instead of 'app'

// Main directives
angular.module('sa.main', [])
	// initiate body
